...
@Composable
fun MyCocktailDetailsRoute(
    viewModel: MyCocktailDetailsViewModel,
) {
    val cocktailDetailsViewState: MyCocktailDetailsViewState by viewModel.cocktailDetailsViewState.collectAsState()

    MyCocktailDetailsScreen(
...
@Composable
fun MyCocktailDetailsScreen(
    cocktailDetailsViewState: MyCocktailDetailsViewState,
